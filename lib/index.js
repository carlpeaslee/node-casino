...
var _TexasHoldem = require('./games/TexasHoldem');

var _TexasHoldem2 = _interopRequireDefault(_TexasHoldem);
...
io.of('/texasholdem').on('connection', function (client) {
  (0, _TexasHoldem2.default)(client, io);
});